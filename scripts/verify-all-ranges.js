...
async function main() {
  ...
  // Clear reminderLogs to start fresh
  ...
  console.log('--- Step 1: Triggering Generate Reminders ---');
  ...
  // Verify expectations:
  const inv28 = pendingLogs.find(l => l.invoiceNumber === 'INV-28D');
  const inv33 = pendingLogs.find(l => l.invoiceNumber === 'INV-33D');
  const inv42 = pendingLogs.find(l => l.invoiceNumber === 'INV-42D');
  const inv48 = pendingLogs.find(l => l.invoiceNumber === 'INV-48D');
  const inv55 = pendingLogs.find(l => l.invoiceNumber === 'INV-55D');

  console.log('\n--- Range Verification Results ---');
  console.log('1. Age 28 (25-30 day range / 3% CD):', inv28 ? '✅ GENERATED (30 Day Reminder)' : '❌ MISSING');
  console.log('2. Age 33 (30-35 day range / PAUSED):', !inv33 ? '✅ PAUSED / NOT GENERATED' : '❌ SHOULD BE PAUSED');
  console.log('3. Age 42 (40-45 day range / 2% CD):', inv42 ? '✅ GENERATED (45 Day Reminder)' : '❌ MISSING');
  console.log('4. Age 48 (45-50 day range / PAUSED):', !inv48 ? '✅ PAUSED / NOT GENERATED' : '❌ SHOULD BE PAUSED');
  console.log('5. Age 55 (50-60 day range / Normal):', inv55 ? '✅ GENERATED (60 Day Reminder)' : '❌ MISSING');
